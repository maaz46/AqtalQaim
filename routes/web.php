...
Route::middleware([CheckSession::class])->group(function () {
    Route::get('/SetDefaultProject', [MainController::class,'SetDefaultProject']);
    Route::post('/SetDefaultProject', [MainController::class,'UpdateDefaultProject']);
    Route::middleware([DefaultProject::class])->group(function () {
        ...
        Route::middleware('PagesAccess:6')->group(function () {
            ...
            Route::post('/UpdatePassword',[MainController::class, 'UpdatePassword'])->middleware('PageActionAccess:6,1');
