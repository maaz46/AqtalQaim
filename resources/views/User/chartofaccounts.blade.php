...
<form action="/ChartOfAccounts" method="POST">
    ...
    <div class="form-group">
        <label for="" style="margin-right:20px">Opening Balance Debit*</label>
        <input type="number" class="type5" value="{{old('opening_balance_debit')}}" name="opening_balance_debit">
    ...
    <div class="form-group">
        <label for="" style="margin-right:20px">Opening Balance Credit*</label>
        <input type="number" class="type5" value="{{old('opening_balance_credit')}}" name="opening_balance_credit">
